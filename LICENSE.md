...
Trade Mark:&emsp;&emsp;&emsp;&emsp;"MDM-labs" is a trade mark of AmidaWare LLC.

Licensor:&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;AmidaWare LLC of 1968 S Coast Hwy PMB 3847 Laguna Beach, CA, USA.

Licensed Software:&emsp;&nbsp;The software known as MDM-labs Version v0.12.0 (and all subsequent releases and versions) and the MDM-labs Agent v2.0.0 (and all subsequent releases and versions).
...
* the offer for sale, distribution or sale of any service or product (whether or not branded as MDM-labs).
...
&emsp;&emsp;&emsp;Licensed under the MDM-labs License Version 1.0 (the “License”).<br>
...
### 10. Trademarks
No permission is granted to use the trademark “MDM-labs” or any other trade name, trademark, service mark or product name of AmidaWare LLC except to the extent necessary to comply with the notice requirements in Section 4 (Copyright Notice).
